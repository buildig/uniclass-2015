...
curl ""$URL"_en_v1_20.xlsx" > Uniclass2015_En.xlsx
curl ""$URL"_ac_v1_14.xlsx" > Uniclass2015_Ac.xlsx
curl ""$URL"_sl_v1_20.xlsx" > Uniclass2015_SL.xlsx
curl ""$URL"_ef_v1_9.xlsx" > Uniclass2015_EF.xlsx
curl ""$URL"_ss_v1_22.xlsx" > Uniclass2015_Ss.xlsx
curl ""$URL"_pr_v1_22.xlsx" > Uniclass2015_Pr.xlsx
curl ""$URL"_te_v1_8.xlsx" > Uniclass2015_TE.xlsx
curl ""$URL"_pm_v1_12.xlsx" > Uniclass2015_PM.xlsx
